...
import '../../plugins/peladoras/peladoras_plugin.dart';
import '../../plugins/icg_frontrest/rest_plugin.dart';
import '../../plugins/futbol/plugin.dart';
import '../../plugins/sensores/sensores_plugin.dart';
import '../../plugins/cultivos/cultivos_plugin.dart';
...
class GestorPlugins {
  ...
  final Map<String, Plugin Function()> _pluginsDisponibles = {
    'peladoras': () => PluginPeladoras(),
    'icg_frontrest': () => PluginICGFrontRest(),
    'futbol': () => PluginFutbol(),
    'sensores': () => PluginSensores(), // Añadimos el nuevo plugin
    'cultivos': () => PluginCultivos(),
  };
